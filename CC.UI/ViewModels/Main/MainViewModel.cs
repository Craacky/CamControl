...
public class MainViewModel : ViewModel
{
    ...
    {
        bool isClosedPallet = ReportTaskService.Statistic.PalletCodes.Count > 0 &&
                              ReportTaskService.Statistic.PalletCodes[^1].IsFulled;
        return !isClosedPallet &&
               (ReportTaskService.Statistic.PalletCodes.Count > 0 &&
                ReportTaskService.Statistic.CountBoxInCurrentPallet > 0) && ReportTaskService.CurrentReportTask != null;
    }
        ...
        IDeviceService deviceService)
    {
        ...
        addBoxesToPreviousPalletCommand = new RelayCommand(OnAddBoxesToPreviousPalletCommandExecuted,
            CanAddBoxesToPreviousPalletCommandExecute);
    }
}