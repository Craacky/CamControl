...
public class DeleteProductAggregationViewModel : ViewModel
{
    ...
    public DeleteProductAggregationViewModel(ProcessingCodeService processingCodeService,
            ...
            if (isProductCode)
            {
                ...
                if (isProductCodeTheCurrentTask)
                {
                    ...
                    if (isRepeatProductCode)
                    {
                        ...
                        {
                            Product deleteProduct = products.FirstOrDefault(b => b.BoxId == CurrentBox.Id);
                            ...
                            if (deleteProduct != null)
                            {
                                ...
                                //Очищаем ошибки связанные с коробом
                                {
                                    var errors = ErrorsService.Errors.FindAll(e =>
                                        e.ProductCode == (deleteProduct.MarkingCode));
                                    ...
                                    CurrentBox =
                                        LocalDBService.BoxDataService.GetWithInclude(CurrentBox.Id, p => p.Pallet);
