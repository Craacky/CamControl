                ...
                if (isBoxCode)
                {
                    ...
                    if (isBoxCodeTheCurrentTask)
                    {
                        ...
                        if (isRepeatBoxCode)
                        {
                            ...
                            {
                                Box deleteBox = boxes.FirstOrDefault(b => b.PalletId == CurrentPallet.Id);
                            ...
                            else 
                            {
                                ...
                                if (result == MessageBoxResult.Yes)
                                {
                                    ...
                                    ReportTaskService.Statistic.BoxCodes = new List<Box>(ReportTaskService.Statistic.BoxCodes);
                                    ...
                                    ReportTaskService.Statistic.ProductCodes = new List<Product>(ReportTaskService.Statistic.ProductCodes);
